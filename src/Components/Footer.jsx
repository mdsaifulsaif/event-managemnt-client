...
const Footer = () => {
  return (
    <footer className="bg-gray-100 md:px-0 px-5  dark:bg-gray-800 dark:text-gray-200 text-gray-700 ">
      <div className=" md:w-6xl mx-auto  py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* About Section */}
        <div>
